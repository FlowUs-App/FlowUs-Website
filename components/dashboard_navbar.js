      ...
      <div className={classes.root2} style={{ marginBottom: "5rem" }}>
        <AppBar position="static" className={classes.appbar}>
          <Toolbar>
            ...
            >
              <path d="M28 30H7V37H28V30Z" fill="#fff" />
              <path d="M28 16H10V22H28V16Z" fill="#fff" />
              <path d="M0 0L0 37H7L7 0H0Z" fill="#fff" />
              <path d="M31 0H10V7H31V0Z" fill="#fff" />
              <path d="M31 0L31 37H38V0H31Z" fill="#fff" />
              <path
